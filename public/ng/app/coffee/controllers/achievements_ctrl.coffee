...
@AchievementsCtrl = @controllerModule.controller 'AchievementsCtrl', ($ionicPlatform, $scope, $state, $ionicSlideBoxDelegate, $ionicModal, moment, achievements, CONFIG, $sce) ->
  $scope.selectedAward = {}
